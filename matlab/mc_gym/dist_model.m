...
counter = 1;
filename = 'matplot/dist_3d.mat';

dvec = 10:10:10 ;
E_3d = zeros(size(lvec,2) , size(dvec,2)) ;
d_count =1 ;
...
%     dist1 = 10;
    ...
    %     lambda = 5;
    %     P_e = 1-ZunPhyModel_d(4,L_payload,127*8*lambda,dist1,5,20);
%         P_e = 1-ZunPhyModel_lam(4,L_payload,127*8*lambda,dist1,5,15);
        P_e = 0;
        Pe(counter) = P_e;
        ...
        Reliability(counter) = (1-P_blocking(counter)) * (1 - (1-Pcf(counter)) * (1- Pcr(counter)));
